...
class LocationsImport implements ToCollection, WithHeadingRow, SkipsOnFailure, WithValidation, WithChunkReading
{
    ...
    {
        return [
            'location_name' => ['required', "regex:/^[0-9\pL\s\()&\/.,'_-]+$/u", 'unique:locations,location_name']
        ];
    }
    ...
    public function customValidationMessages(): array
    {
        return [
            ...
            'location_name.regex' => 'Special characters are not allowed. Valid characters: (A-z 0-9 -,_.).',
        ];
    }
