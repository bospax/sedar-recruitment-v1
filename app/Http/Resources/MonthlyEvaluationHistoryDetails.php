...
class MonthlyEvaluationHistoryDetails extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'development_plan' => json_decode($this->development_plan),
            'development_area' => json_decode($this->development_area),
            'developmental_plan' => $this->developmental_plan,
