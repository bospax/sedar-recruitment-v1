...
class ManpowerForRegistration extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $manpower_details = $this->code.' | '.$this->position_name.' | '.$this->position_department.' | '.$this->position_subunit.' | '.$this->team.' | '.$s_full_name;
        ...
        return [
            ...
            'position_subunit' => $this->position_subunit,
