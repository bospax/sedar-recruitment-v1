...
class EmployeesImport implements ToCollection, WithHeadingRow, SkipsOnFailure, WithValidation, WithChunkReading
{
    ...
    {
        return [
            'first_name.required' => 'Employee Name is required.',
