...
class ManpowerDetailWithApprover extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        $effectivity = ($this->effectivity_date) ? Carbon::createFromFormat('Y-m-d', $this->effectivity_date)->format('M d, Y') : '';
        ...
        return [
            ...
            'approver_full_name' => $this->approver_full_name,
