...
class DegreesImport implements ToCollection, WithHeadingRow, SkipsOnFailure, WithValidation, WithChunkReading
{
    ...
    public function customValidationMessages(): array
    {
        return [
            ...
            'degree_name.regex' => 'Special characters are not allowed. Valid characters: (A-z 0-9 -,_.).',
        ];
    }
